...
class CJoint : public CSceneObject
{
  public:
    ...
    void pushDependencyDataEvents(CCbor* ev = nullptr) const override;
    ...
    int setBoolProperty(const char* pName, bool pState, CCbor* eev);
    ...
    int setIntArray2Property(const char* pName, const int* pState, CCbor* eev);
    ...
    int setVector3Property(const char* pName, const C3Vector& pState, CCbor* eev);
    ...
    int setFloatArrayProperty(const char* pName, const std::vector<double>& pState, CCbor* eev);
